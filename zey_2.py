...
def main():
    ## reading data
    data = pd.read_excel('excel nepnew - Haziran1.xlsx', sheet_name='GRUP TAHMİNLİ', header=0)
    ...
    regressors_data = pd.read_excel('excel nepnew - Haziran1.xlsx', sheet_name='GRUP TAHMİNLİ', header=0, usecols=(
        ...
        'DEMAND/1000',
        'LOGRUZGAR', 
        'LOGJEO', 'LOGBARAJ', 'LOGBIO', 'LOGAKARS', 
        'LOGDEMAND',
        'WEEKEND',
        'HOUR',
        'TOP/1000', 
        'YENILORAN',
        'YATSAPMA-48/1000',
        'YATSAPMA-24/1000', 'YATSAPMA-168/1000'
    ))
    ...
    Y_data_set = data.get("YATSAPMA/1000")
   ...
   # reading X values
    ...
    Y_data_set_tahmin = data_tahmin.get('YATSAPMA/1000')
